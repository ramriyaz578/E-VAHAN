...
const parsehtml= parse.parseFromString(data, 'text/html');

const tbody = parsehtml.getElementsByTagName('tbody')[0];

const tbodychild= tbody.children
...
[...tbody.children].forEach((record) => {
    let recordChildren = record.children;
    ...
    rtoData.push({
       ID: id,
       RTOCODE:  recordChildren[0].innerText,
...
function download() {
    const aEl= document.createElement('a')
     const file = new Blob([JSON.stringify(rtoData, null, (2))],{
